...
prompt_template_inicial = ChatPromptTemplate.from_messages(
    [
        ...
        ("human", "Liste de forma estruturada os principais detalhes e pontos de vistas apresentados na seguinte review entrega pelo usuário. Não invente nada apenas capture as principais informações apresentadas. Review: {movie_review}"),
    ]
)
...
analise_ponto_positivo_template = ChatPromptTemplate(
    [
        ...
        ("human", "Dado esta review estruturada: {review_estruturado}, liste os pontos positivos do filme.")
    ]
)
...
chain = (prompt_template_inicial
         ...
         | {"positiva": chain_intermediaria_positiva, "negativa": chain_intermediaria_negativa} # execução paralela
